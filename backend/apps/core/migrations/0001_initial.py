...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status', 'created_at'], name='core_task_status_idx'),
        ),
        migrations.AddIndex(
            model_name='taskqueue',
            index=models.Index(fields=['user', 'status'], name='core_task_user_idx'),
        ),
        migrations.AddConstraint(
            model_name='usernotification',
            constraint=models.UniqueConstraint(condition=models.Q(task__isnull=False), fields=['user', 'task', 'notification_type'], name='unique_user_task_notification'),
        ),
    ]
