    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['user', 'created_at'], name='accounts_auditlog_user_created_idx'),
                    models.Index(fields=['acao', 'created_at'], name='accounts_auditlog_acao_created_idx'),
                ],
            },
        ),
    ]
